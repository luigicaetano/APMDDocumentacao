...
<div class="step-section">
  ...
  {{< figure src="../assets/images/visualizações.png" alt="Configuração da tabela no PowerBi" >}}
  {{< figure src="../assets/images/colunas.png" alt="Configuração da tabela no PowerBi" >}}
</div>
</div>
